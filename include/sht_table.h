...
typedef struct {
    int  fileDesc;  // secondary hash table file descriptor
    int  primaryDesc;   // primary hash table file descriptor
    int  numBuckets;
    int  myBlockNumber;
    int  maxRecords;
    int  fileType;
    ...
    int  SHT_BUCKET_ID[MAXBUCKETS]; // last block id in this bucket
    int  SHT_INDEX_RECS[MAXBUCKETS];// record counter for this bucket
